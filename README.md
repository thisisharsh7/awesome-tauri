...
- [Whispering](https://github.com/EpicenterHQ/epicenter/tree/main/apps/whispering) ![v2] - Open-source speech-to-text app. Press shortcut → speak → get text. Supports local (Whisper C++) and cloud transcription with AI transformations.
